...
const DevProfileScreen: React.FC = () => {
        ...
        <div className="flex flex-col h-screen bg-[#f8fafc] dark:bg-gray-950 transition-colors duration-500 relative overflow-hidden font-sans">
            ...
            <header className="px-6 py-6 pt-12 flex items-center justify-between z-30 relative">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-light text-gray-900 dark:text-white tracking-tight">System Profile</h1>
                    </div>
                </div>
            ...
            <main className="flex-1 px-6 overflow-y-auto no-scrollbar pb-32 z-10 relative">
                ...
                <section className="mt-4 mb-8">
                    <div className="bg-indigo-600 rounded-[40px] p-8 shadow-[0_12px_40px_rgba(79,70,229,0.25)] text-white relative overflow-hidden">
                                ...
                                <div className="w-24 h-24 rounded-[32px] p-1 bg-white/20 backdrop-blur-md shadow-xl">
                                    <div className="w-full h-full rounded-[28px] bg-white overflow-hidden flex items-center justify-center">
                                        {profile.photo_path ? (
                                            ...
                                            <span className="text-4xl font-light text-indigo-600 uppercase">{profile.full_name?.charAt(0)}</span>
                                        )}
                                    </div>
                                </div>
                                <button className="absolute -bottom-2 -right-2 w-8 h-8 bg-white text-indigo-600 rounded-xl shadow-lg flex items-center justify-center border-4 border-indigo-700">
                                    <MdEdit size={14} />
                                </button>
                            </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-white dark:bg-zinc-900/80 rounded-[36px] p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
                    ...
                    <div className="bg-white dark:bg-zinc-900/80 rounded-[36px] p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-base font-light text-gray-900 dark:text-white tracking-tight">Primary Assignment</h3>
                            </div>
                        </div>

                        <div className="flex flex-col gap-3">
                            {profile.branch_id ? (
                                <div className="p-5 rounded-[24px] border border-gray-50 dark:border-white/5 bg-[#f8fafc] dark:bg-black/20 flex items-center justify-between group transition-all active:scale-[0.98]">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-2xl bg-white dark:bg-zinc-800 flex items-center justify-center text-teal-500 shadow-sm border border-gray-100/50 dark:border-white/5">
                                            <MdBusiness size={18} />
                                        </div>
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-800 dark:text-gray-200">{profile.branch_name || 'Home Branch'}</h4>
                                            <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5">{profile.city || 'Headquarters'}</p>
                                        </div>
                                    </div>
                                    <div className="text-[10px] font-medium text-gray-400">#{profile.branch_id}</div>
                                </div>
                            ) : branches.length > 0 ? branches.map(branch => (
                                <div key={branch.branch_id} className="p-5 rounded-[24px] border border-gray-50 dark:border-white/5 bg-[#f8fafc] dark:bg-black/20 flex items-center justify-between group transition-all active:scale-[0.98]">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-2xl bg-white dark:bg-zinc-800 flex items-center justify-center text-teal-500 shadow-sm border border-gray-100/50 dark:border-white/5">
                                            <MdBusiness size={18} />
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5">Assigned Center</p>
                                        </div>
                                    </div>
                                    <div className="text-[10px] font-medium text-gray-400">#{branch.branch_id}</div>
                                </div>
                            )) : (
                                <p className="text-xs text-center text-gray-400 py-4 font-light">No operational branches linked</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-zinc-900/80 rounded-[36px] p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <button 
                                ...
                                className="w-full flex items-center justify-between p-5 rounded-[24px] border border-gray-100 dark:border-white/5 bg-[#f8fafc] dark:bg-black/20 group active:scale-[0.98] transition-all"
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-2xl bg-white dark:bg-zinc-800 flex items-center justify-center text-rose-400 shadow-sm border border-gray-100/50 dark:border-white/5">
                                        <MdVpnKey size={18} />
                                    </div>
                ...
                <div className="py-10 text-center">
                    <p className="text-[10px] font-medium text-gray-300 uppercase tracking-[0.4em]">Physio EZ • v3.2</p>
                </div>
            </main>
            ...
            {showPassModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                    ...
                    <div className="relative w-full max-w-sm bg-white dark:bg-zinc-900 rounded-[40px] shadow-2xl animate-scale-in border border-gray-100 dark:border-white/10 overflow-hidden">
                        ...
                        <form onSubmit={handlePasswordChange} className="p-8 pt-4 space-y-6">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input 
                                            ...
                                            className="w-full h-14 bg-gray-50 dark:bg-black/50 rounded-2xl px-12 text-sm focus:ring-2 focus:ring-indigo-500/20 border-none outline-none transition-all dark:text-white"
                                            placeholder="••••••••"
                                        />
                            ...
                            <button 
                                ...
                                className="w-full h-14 bg-indigo-500 text-white rounded-[24px] text-sm font-medium uppercase tracking-[0.2em] shadow-lg shadow-indigo-500/20 active:scale-95 transition-all disabled:opacity-50 disabled:active:scale-100 flex items-center justify-center"
                            >
                                {passLoading ? (
