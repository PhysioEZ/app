...
- **📊 Executive Dashboard**
  ...
  - Visual analytics for daily revenue, patient footfall, and operational metrics.
  - Quick-access counters for registrations, tests, and active treatments.

- **👥 Patient Lifecycle Management**

  - Digital registration and profile management.
  - Easy access to treatment plans, medical history, and prescribed tests.

- **📅 Appointment System**

  - Streamlined booking process.
  - Status tracking (Checked-in, In-queue, Completed).

- **💰 Billing & Finance**

  - Integrated invoicing for services and pharmacy.
  - Expense management module for tracking clinic overheads.

- **⚡ Operational Efficiency**
  - Lab test order management.
  - Staff attendance and roster monitoring.
  - Secure and responsive interface designed for mobile use.
